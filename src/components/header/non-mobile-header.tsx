...
export function NonMobileHeader() {
  return (
    <div className="animate__animated animate__fadeInDown fixed z-20 flex h-14 w-full items-center gap-2 border border-b bg-background px-5 max-sm:hidden">
